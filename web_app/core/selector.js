function Selector({panel, group, eventsDispatcher, oscSender, oscLabel, x, y, size, color, onColor, offColor, array, index, caption}) {
  ...
  this.oscSender.send([this.oscLabel, this.array[this.index]])
  this.draw();
}
